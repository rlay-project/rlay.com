...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.rlay_ontology_stdweb = factory();
    }
}( this, function() {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_e53933559a53985cba5a4c83df023638b2319985": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){console.error (($1));})());
            },
            "__extjs_d8a439451216bbc6cd9f3012f189d2ad6a2e9459": function($0) {
                Module.STDWEB.decrement_refcount( $0 );
            },
            "__extjs_58148cd4465d37b84778fc37c49966856b91dc54": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){console.warn (($1));})());
            },
            "__extjs_d3be80359baf67cec8153b265d5ae0231e281591": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){console.info (($1));})());
            },
            "__extjs_6651154b81b7a788c128c205c1fffbf6e409c57c": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){console.debug (($1));})());
            },
            ...
            "__extjs_8615dcfbb63150bbf5137cb57a232017beba6b7d": function($0, $1, $2, $3, $4, $5) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);$4 = Module.STDWEB.to_js($4);$5 = Module.STDWEB.to_js($5);Module.STDWEB.from_js($0, (function(){Module.exports.print_class = ($1); Module.exports.annotation_property_label = ($2); Module.exports.hash_annotation = ($3); Module.exports.hash_class = ($4); Module.exports.hash_individual = ($5);})());
            },
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'rlay_ontology_stdweb'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'rlay_ontology_stdweb':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" ) {
        ...
        const wasm_path = path.join( __dirname, "rlay_ontology_stdweb.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "rlay_ontology_stdweb.wasm" )
